...
namespace OS_Sips
{
    public class OS_SipsPaymentProvider : Nevoweb.DNN.NBrightBuy.Components.Interfaces.PaymentsInterface
    {
        ...
        public override string GetTemplate(NBrightInfo cartInfo)
        {
            ...
            templ = NBrightBuyUtils.RazorTemplRender(templateName, 0, "", info, "/DesktopModules/NBright/OS_Sips", "config", Utils.GetCurrentCulture(), passSettings);
        ...
        private string GetReturnTemplate(OrderData orderData, bool paymentok, string paymenterror)
        {
            ...
            if (paymentok)
            {
                ...
                templ = NBrightBuyUtils.RazorTemplRender(displaytemplate, 0, "", info, "/DesktopModules/NBright/OS_Sips", "config", Utils.GetCurrentCulture(), passSettings);
            }
            else
            {
